...
x1 = themis_lolat.precipitating_fluxes_mean.-themis_lolat.precipitating_fluxes_minus .+ 1.
x2 = themis_lolat.precipitating_fluxes_mean.+themis_lolat.precipitating_fluxes_plus .+ 1.
y1 = themis_midlat.precipitating_fluxes_mean.-themis_midlat.precipitating_fluxes_minus .+ 1.
y2 = themis_midlat.precipitating_fluxes_mean.+themis_midlat.precipitating_fluxes_plus .+ 1.
z1 = themis_hilat.precipitating_fluxes_mean.-themis_hilat.precipitating_fluxes_minus .+ 1.
z2 = themis_hilat.precipitating_fluxes_mean.+themis_hilat.precipitating_fluxes_plus .+ 1.
...
plot(Egrid, themis_hilat.equatorial_fluxes, label = L"\mathrm{equatorial\ flux\ (THEMIS\ A\ measured)}", color = bipride_pink, linewidth=2, markershape=:circle);
plot!(Egrid,themis_lolat.precipitating_fluxes_mean, fillrange=x1, fillalpha = 0.2, color = c4, label=false)
plot!(Egrid,themis_lolat.precipitating_fluxes_mean, fillrange=x2, fillalpha = 0.2, color = c4, label=false)
plot!(Egrid, themis_lolat.precipitating_fluxes_mean, label=L"\mathrm{precipitating\ flux\ }(\mathrm{simulated\ with\ }\delta\lambda_2 = 20\degree)",
...
plot!(Egrid,themis_midlat.precipitating_fluxes_mean, fillrange=y1, fillalpha = 0.2, color = c3, label=false)
plot!(Egrid,themis_midlat.precipitating_fluxes_mean, fillrange=y2, fillalpha = 0.2, color = c3, label=false)
plot!(Egrid, themis_midlat.precipitating_fluxes_mean, label=L"\mathrm{precipitating\ flux\ }(\mathrm{simulated\ with\ }\delta\lambda_2 = 30\degree)",
        yerror=(themis_midlat.precipitating_fluxes_minus, themis_midlat.precipitating_fluxes_plus),
        color = c3, alpha = .7, markerstrokecolor = c3, markerstrokewidth = 2, markershape=:o, markersize = 2);
plot!(Egrid,themis_hilat.precipitating_fluxes_mean, fillrange=z1, fillalpha = 0.2, color = bipride_orange, label=false)
plot!(Egrid,themis_hilat.precipitating_fluxes_mean, fillrange=z2, fillalpha = 0.2, color = bipride_orange, label=false)
plot!(Egrid, themis_hilat.precipitating_fluxes_mean, label=L"\mathrm{precipitating\ flux\ }(\mathrm{simulated\ with\ }\delta\lambda_2 = 40\degree)",
...
plot!(elfin_measurements_042921, yerror=elfin_error_042921.+10, label = L"\mathrm{precipitating\ flux\ (ELFIN\ B\ measured)}",
        color = c5, marker = stroke(3,c5), linewidth=3);
