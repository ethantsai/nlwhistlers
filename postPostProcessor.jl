...
plot!(Egrid, themis_hilat.precipitating_fluxes_mean,
        ...
        color = bipride_lavender, alpha = .5, label="dLambda2 = 40 deg", markershape=:x)
plot!(Egrid, themis_lolat.precipitating_fluxes_mean,
...
# Plots for 9/22/20
# @save "200922_data_storage.jld2" mms_midlat mms_hilat
...
plot!(Egrid, mms_hilat.precipitating_fluxes_mean,
        yerror=(mms_hilat.precipitating_fluxes_minus, mms_hilat.precipitating_fluxes_plus),
        color = bipride_lavender, alpha = .5, label="dLambda2 = 40 deg", markershape=:+)
