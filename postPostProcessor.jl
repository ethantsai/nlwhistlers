...
# Plots for 4/29/21
@time @load "results/210429_lat_storage_cleaned.jld2" equatorial_fluxes_042921 themis_hilat_042921 themis_midlat_042921 themis_lolat_042921
...
bigplot = plot(twenty,thirty,forty, dpi = 96, layout = (3,1), left_margin = 16mm, size=(600,2000))
savefig(bigplot, "images/dlambda_trajectories.pdf")
savefig(bigplot, "images/dlambda_trajectories.png")
...
bigphiplot = plot(short,med,long, dpi = 96, layout = (3,1), left_margin = 16mm, top_margin = 2mm, size=(500,2000))
