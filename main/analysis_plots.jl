...
nite_plot_hil = plot!(E, dc_norm * prec_ratio_wna1, label = "FAW, QLDC, Ω_pe = 6.5",  color = colour, linewidth=2, linestyle=:dash)
...
nite_plot_hil = plot!(E, dc_norm * prec_ratio_wna2, label = "FAW, QLDC, Ω_pe = 3",  color = colour, linewidth=2, linestyle=:dash)
