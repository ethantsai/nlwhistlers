...
relative_oblique_comparison_plot = plot!(legendfontsize=12, tickfontsize=12, legend=:bottomleft)
relative_oblique_comparison_plot = plot!(dpi = 500,size=(1000,600), margin=20px, bottom_margin=12px)
...
relative_oblique_comparison_qldc_plot = plot!(legendfontsize=12, tickfontsize=12, legend=:bottomleft)
relative_oblique_comparison_qldc_plot = plot!(dpi = 500,size=(1000,600), margin=20px, bottom_margin=12px)
